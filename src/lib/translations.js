...
`,
	...
	en: {
		intro: {
			title: 'Dear User,',
			description: `<p>Before you click “Go to website” or close this window please read this notice in whole – it concerns your personal data.<br> <b>By clicking “Go to website” or closing this window by clicking the X sign you grant consent for processing of your personal data</b> relating to your activity in the Internet by the <a onclick="__tcfapi('showVendors', 2, function () {})">Trusted Partners</a> for marketing purposes (including personalization od the ads and measurements). <a href="https://polityka-prywatnosci.onet.pl/index.html" target="_blank" rel="noopener">Here</a> you find detailed description of the purposes and scope of the processed data. The consent is voluntary. You may refuse it or limit its scope clicking on “Advanced settings”.</p>
<p>Entities from the <a onclick="__tcfapi('showVendors', 2, function () {})">RAS Polska Group</a> as provides of the Internet services you use process your personal data specified above together with data from your accounts in these services  on the basis of legitimate, common interest of these entities. Such processing does not require your consent, but you may object to it at any time.</p>
...
<br>
<p>Using the service without adjustment of the browser is also considered as consent for to the placement of web flags/markers (cookies, etc.) on your device and reading them by Entities from the <a onclick="__tcfapi('showVendors', 2, function () {})">RAS Polska Group</a> and <a onclick="__tcfapi('showVendors', 2, function () {})">Trusted Partners</a>. You may refuse the consent or limit its scope by changing the browser settings (you will find detailed information <a href="https://polityka-prywatnosci.onet.pl/index.html" target="_blank" rel="noopener">here</a>).</p>`,
