...
<br>
<p><span style="font-weight: bold; display: inline">Klikając „Przejdź do serwisu” lub zamykając okno przez kliknięcie w znaczek X, udzielasz zgody na przetwarzanie Twoich danych osobowych</span> dotyczących Twojej aktywności w Internecie (np. identyfikatory urządzenia, adres IP) przez <a onclick="__tcfapi('showVendors', 2, function () {})">Zaufanych Partnerów IAB</a> i innych <a onclick="__tcfapi('showCustomVendors', 2, function () { })">Zaufanych Partnerów</a> w celach marketingowych (w tym dla personalizacji reklam i dokonywania pomiarów) i w celu dostosowania dostarczanych treści. Szczegółowy opis celów i zakresu przetwarzanych danych znajdziesz <a href="_PRIVACYPOLICY_" target="_blank" rel="noopener">tutaj</a> - obejmują one (klasyfikacja wg IAB Europe) m.in.: wybór podstawowych reklam; tworzenie profilu spersonalizowanych reklam; wybór spersonalizowanych reklam; tworzenia profilu spersonalizowanych treści; wybór spersonalizowanych treści; pomiar wydajności reklam; pomiar wydajności treści; stosowanie badań rynkowych w celu generowania opinii odbiorców; opracowywanie i ulepszanie produktów oraz funkcje specjalne takie jak: użycie dokładnych danych geolokalizacyjnych i aktywne skanowanie charakterystyki urządzenia do celów identyfikacji. Zgoda jest dobrowolna. Możesz jej odmówić lub ograniczyć jej zakres klikając w "Ustawienia zaawansowane".</p>
<br>
<p> _ORGANIZATION1_ usług internetowych, z których korzystasz oraz niektórzy z <a onclick="__tcfapi('showVendors', 2, function () {})">Zaufanych Partnerów IAB</a> i innych <a onclick="__tcfapi('showCustomVendors', 2, function () { })">Zaufanych Partnerów</a> przetwarzają Twoje dane podane powyżej oraz dane z Twoich kont w tych usługach w ww. celach w oparciu o prawnie uzasadniony interes tych podmiotów. Przetwarzanie to nie wymaga zgody z Twojej strony, ale możesz mu się w każdej chwili sprzeciwić.</p>
<br>
...
<br>
<p>Korzystanie z serwisu bez zmiany ustawień przeglądarki oznacza też zgodę na umieszczanie znaczników internetowych (cookies itp.) na Twoich urządzeniach i odczytywanie ich (przechowywanie informacji na urządzeniu lub dostęp do nich) _ORGANIZATION2_ oraz przez <a onclick="__tcfapi('showVendors', 2, function () {})">Zaufanych Partnerów IAB</a> i innych <a onclick="__tcfapi('showCustomVendors', 2, function () { })">Zaufanych Partnerów</a>. Zgody tej możesz odmówić lub ją ograniczyć poprzez zmianę ustawień przeglądarki (szczegółowe informacje znajdziesz <a href="_PRIVACYPOLICY_" target="_blank" rel="noopener">tutaj</a>).</p>
`,
	...
	tabs: {
		tab1: {
			...
			title: 'Szanowna Użytkowniczko, Szanowny Użytkowniku,',
			description: `<p>Znajdujesz się z szczegółowej sekcji mechanizmu umożliwiającego zarządzanie procesami przetwarzania Twoich danych osobowych na stronach internetowych i innych narzędziach udostępnianych przez _ORGANIZATION3_ </p>
...
<p>Jeśli chcesz zgodzić się na przetwarzanie przez <a onclick="__tcfapi('showVendors', 2, function () {})">Zaufanych Partnerów</a> Grupy _ORGANIZATIONNAME_ Twoich danych osobowych, zawierających informacje o odwiedzonych stronach i aplikacjach internetowych, informacje zapisane w plikach cookies w Twoim urządzeniu i jego pamięci podręcznej oraz dane lokalizacyjne generowane przez Twoje urządzenie, w celach marketingowych (obejmujących zautomatyzowaną analizę Twojej aktywności na stronach internetowych i w aplikacjach w celu ustalenia Twoich potencjalnych zainteresowań dla dostosowania reklamy i oferty) w tym na umieszczanie znaczników internetowych (cookies itp.) na Twoich urządzeniach i odczytywanie takich znaczników, kliknij przycisk „Przejdź do serwisu” lub zamknij to okno. Jeśli nie chcesz wyrazić zgody lub ograniczyć jej zakres, kliknij „Ustawienia zaawansowane”. Wyrażenie zgody jest dobrowolne. Możesz edytować zakres zgody (w tym np. udzielić jej dla danej grupy administratorów lub dla danego rodzaju działań), w tym wycofać ją całkowicie, klikając „Ustawienia zaawansowane” lub przechodząc na naszą stronę <a href="_PRIVACYPOLICY_" target="_blank" rel="noopener">polityki prywatności</a>.</p>
<br>
<p>Powyższa zgoda dotyczy przetwarzania Twoich danych osobowych w celach marketingowych Zaufanych Partnerów. Zaufani Partnerzy to firmy z obszaru e-commerce i reklamodawcy oraz działające w ich imieniu domy mediowe i podobne organizacje, z którymi Grupa _ORGANIZATIONNAME_ współpracuje lub które polecane są przez międzynarodowe organizacje branżowe takie jak np. organizacja IAB (Interactive Advertising Bureau). Niektórzy z Zaufanych Partnerów mogą przetwarzać Twoje dane w węższym zakresie, niektórzy z nich mogą też przetwarzać te dane w oparciu o inną podstawę niż Twoja zgoda (np. w oparciu o uzasadniony interes administratora). Kompletną listę Zaufanych Partnerów wraz z zakresem danych przetwarzanych przez nich w oparciu o Twoją zgodę lub inną podstawę prawną znajdziesz bezpośrednio pod tym <a href="_PRIVACYPOLICY_" target="_blank" rel="noopener">linkiem</a>.</p>
<br>
<p>_ORGANIZATION4_ w ramach udostępnianych przez siebie usług internetowych przetwarza Twoje dane opisane na wstępie, a także zagregowane informacje o wieku, płci i lokalizacji (wielkości miasta z którego pochodzisz itp.) pochodzące z Twoich kont w usługach świadczonych przez _ORGANIZATION5_ w celach marketingowych w oparciu o prawnie uzasadniony interes tego podmiotu. Dane te są jednocześnie danymi niezbędnymi do realizacji umowy zawartej z Tobą, która dotyczy korzystania przez Ciebie z naszych usług i serwisów internetowych, ze względu na właściwości tych usług. Treść tej umowy określa regulamin portalu _REGULATIONS_ Administratorem Twoich danych osobowych jest _ORGANIZATION6_, z którego serwisu lub aplikacji korzystasz – jego nazwę znajdziesz zawsze na dole strony internetowej lub w aplikacji, informuje o niej także graficzne logo Administratora</p>
<br>
<p>Twoja dobrowolna zgoda będzie też podstawą transferu Twoich danych przez część z naszych Zaufanych Partnerów do państw trzecich tj. poza EOG. Poza EOG, np. w USA, stopień ochrony danych osobowych może być słabszy niż wymagany w UE. Informacje o Zaufanych Partnerach spoza EOG znajdują się w politykach prywatności Zaufanych Partnerów.</p>
<br>
...
<p>Na naszych stronach i w aplikacjach używamy znaczników internetowych takich jak pliki np. cookie lub local storage do zbierania i przetwarzania danych osobowych w celu personalizowania treści i reklam oraz analizowania ruchu na stronach, aplikacjach i w Internecie. W ten sposób technologię tę _USE_ oraz nasi Zaufani Partnerzy, którzy także chcą dopasowywać reklamy do Twoich preferencji. Cookies to dane informatyczne zapisywane w plikach i przechowywane na Twoim urządzeniu końcowym (tj. twój komputer, tablet, smartphone itp.), które przeglądarka wysyła do serwera przy każdorazowym wejściu na stronę z tego urządzenia, podczas gdy odwiedzasz strony w Internecie. Szczegółową informację na temat plików cookie i ich funkcjonowania znajdziesz <a href="_PRIVACYPOLICY2_" target="_blank" rel="noopener">pod tym linkiem</a>. Pod tym linkiem znajdziesz także informację o tym jak zmienić ustawienia przeglądarki, aby ograniczyć lub wyłączyć funkcjonowanie plików cookies itp. oraz jak usunąć takie pliki z Twojego urządzenia.</p>

<p style="margin: 25px 0 10px 0; font-weight: 900" class="cmp-translations_purposes_header">Twoje uprawnienia</p>
<p>Przysługują Ci następujące uprawnienia wobec Twoich danych i ich przetwarzania przez _PROCESSING_ i Zaufanych Partnerów:</p>
<br>
...
<p>2. Masz również prawo żądania dostępu do Twoich danych osobowych, ich sprostowania, usunięcia lub ograniczenia przetwarzania, prawo do przeniesienia danych, wyrażenia sprzeciwu wobec przetwarzania danych oraz prawo do wniesienia skargi do organu nadzorczego, którym w Polsce jest Prezes Urzędu Ochrony Danych Osobowych. <a href="_PRIVACYPOLICY_" target="_blank" rel="noopener">Pod tym adresem</a> znajdziesz dodatkowe informacje dotyczące przetwarzania danych i Twoich uprawnień.</p>
<br>
...
<br>
<p><a href="_PRIVACYPOLICY_" target="_blank" rel="noopener">Pod tym linkiem</a> znajdziesz szczegółowy opis celów przetwarzania danych dla których możesz udzielić zgód (lub selektywnie bądź całościowo je odwołać), a poniżej prezentujemy ich rodzaje z opisem stworzonym przez IAB Europe:</p>
...
<li style="margin-bottom: 10px">
	...
	<br>
	- zmierzyć, czy ii w jaki sposób reklamy były dostarczane użytkownikowi i jaka była jego reakcja;
	<br>
...
`
	...
	purposes: {
		...
		purpose1: {
			...
			description: '<p>Pliki cookie, identyfikatory urządzeń lub inne informacje mogą być przechowywane na urządzeniu użytkownika lub udostępniane na nim w przedstawionych użytkownikowi celach.</p>'
		},
		purpose2: {
			title: 'Wybór podstawowych reklam',
			description: '<p>Reklamy mogą być wyświetlane w oparciu o oglądaną treść, używaną aplikację, przybliżoną lokalizację lub typ urządzenia.</p>'
		},
		purpose3: {
			title: 'Tworzenie profilu spersonalizowanych reklam',
			description: '<p>Profil może być zbudowany na temat użytkownika i jego zainteresowań, co pozwoli na pokazywanie spersonalizowanych reklam, które są dla użytkownika istotne.</p>'
		},
		purpose4: {
			title: 'Wybór spersonalizowanych reklam',
			description: '<p>Spersonalizowane reklamy mogą być wyświetlane użytkownikowi na podstawie jego profilu.</p>'
		},
		purpose5: {
			title: 'Tworzenie profilu spersonalizowanych treści',
			description: '<p>Profil może być zbudowany na temat użytkownika i jego zainteresowań, co pozwoli na pokazywanie spersonalizowanych treści, które są dla użytkownika istotne.</p>'
		},
		purpose6: {
			title: 'Wybór spersonalizowanych treści',
			description: '<p>Spersonalizowane treści mogą być wyświetlane użytkownikowi na podstawie jego profilu.</p>'
		},
		purpose7: {
			title: 'Pomiar wydajności reklam',
			description: '<p>Można zmierzyć wydajność i efektywność reklam, które użytkownik widzi lub na które reaguje.</p>'
		},
		purpose8: {
			title: 'Pomiar wydajności treści',
			description: '<p>Można zmierzyć wydajność i efektywność treści, które użytkownik widzi lub na które reaguje.</p>'
		},
		purpose9: {
			title: 'Stosowanie badań rynkowych w celu generowania opinii odbiorców',
			description: '<p>Badania rynku mogą być wykorzystywane w celu uzyskania dalszych informacji na temat odbiorców, którzy odwiedzają strony/aplikacje i oglądają reklamy.</p>'
		},
		purpose10: {
			title: 'Opracowywanie i ulepszanie produktów',
			description: '<p>Dane użytkownika mogą być wykorzystywane do ulepszania istniejących systemów i oprogramowania oraz opracowania nowych produktów.</p>'
		}
	},
	specialPurposes: {
		...
		purpose2: {
			title: 'Techniczne dostarczenie reklam lub treści',
			description: '<p>Urządzenie użytkownika może odbierać i wysyłać informacje, które umożliwiają przeglądanie reklam i treści oraz reagowanie na nie.</p>'
		}
	},
	features: {
		title: 'Funkcje',
		...
		feature2: {
			title: 'Łączenie różnych urządzeń',
			description: '<p>Różne urządzenia mogą być określane jako należące do użytkownika lub jego gospodarstwa domowego do realizacji co najmniej jednego celu.</p>'
		},
		feature3: {
			title: 'Odbieranie i wykorzystywanie automatycznie wysłanej charakterystyki urządzenia do identyfikacji',
			description: '<p>Urządzenie może się odróżniać od innych urządzeń w oparciu o informacje, które automatycznie przesyła, takie jak adres IP lub typ przeglądarki.</p>'
		}
	},
	specialFeatures: {
		...
		feature2: {
			title: 'Aktywne skanowanie charakterystyki urządzenia do celów identyfikacji',
			description: '<p>Urządzenie użytkownika można zidentyfikować na podstawie skanu unikalnej kombinacji cech urządzenia.</p>'
		}
	},
	iabVendors: {
		...
		editingDescription: 'Poniżej znajduje się lista podmiotów, którym możesz wyrazić zgodę opisaną w poprzednim oknie. Dzięki tej zgodzie możliwe będzie lepsze dopasowania treści i reklam prezentowanych przez naszych Zaufanych Partnerów do Twoich zainteresowań. Jeśli nie wyrażasz zgody danemu Zaufanemu Partnerowi kliknij poniżej w „Zmień ustawienia Zaufanych Partnerów” i odznacz wybraną opcję.',
...
const fr = {
	intro: {
		...
		description:
			`<p>Lorsque vous utilisez nos sites web et nos applications, nous collectons, ainsi que des tiers, des informations vous concernant au moyen de cookies et de diverses autres technologies.</p>

<p>Certaines de ces technologies sont nécessaires au bon fonctionnement de nos sites web et applications. D’autres sont facultatives et nous aident à améliorer continuellement nos produits et services et à les adapter à vos besoins, à reconnaître les tendances, à créer et à évaluer des statistiques sur l’utilisation de nos offres numériques et à pouvoir vous diffuser de la publicité personnalisée.</p>

<p>La plupart des traitements de données susmentionnés sont effectués sur la base de l’intérêt légitime, tandis que d’autres ne peuvent être effectués qu’avec votre consentement. Vous pouvez vous opposer au traitement fondé sur l’intérêt légitime à tout moment et également révoquer votre consentement à tout moment. Vous trouverez de plus amples informations à ce sujet dans la rubrique Paramètres.</p>
...
<p><a href="https://www.blick.ch/services/datenschutzbestimmungen-id151553.html" target="_blank" rel="noopener">Datenschutz</a> | <a href="https://www.blick.ch/services/impressum/impressum-blick-gruppe-id5697115.html" target="_blank" rel="noopener">Impressum</a></p>`,
	...
	tabs: {
		tab1: {
			...
			title: `<span class="cmp-translations_detailTitle">Pourquoi collectons-nous vos données?</span>`,
			description: `<p>Nous, ainsi que nos partenaires, collectons et traitons vos données pour que nos sites web et nos applications
fonctionnent de manière irréprochable et afin de pouvoir améliorer continuellement nos produits et services et les
adapter à vos besoins, d’identifier les tendances, et de compiler et évaluer des statistiques sur l’utilisation de nos
offres numériques. Ces données sont également utilisées pour vous fournir un contenu adapté à vos intérêts et une bonne
expérience publicitaire.</p>

<p>Vous avez la possibilité d’arrêter le traitement de ces données à tout moment. Vous trouverez des informations sur
la manière de procéder sous  <a onclick="__tcfapi('showConsentDetailView', 2, function () {}, {tab: 1})">traitement de vos données</a></p>


<p style="margin: 25px 0 10px 0; font-weight: 900" class="cmp-translations_purposes_header">Sur quelle base juridique faisons-nous cela?</p>
<p>Nous et nos partenaires traitons vos données soit parce que vous avez consenti à ce traitement, soit parce que nous
avons un intérêt légitime ou un intérêt privé prépondérant à le faire.</p>

<p>Certains de nos partenaires exigent ou certains traitements requièrent votre consentement conformément à l’art. 6, al. 1a RGPD.
Vous pouvez nous donner ce consentement dans vos paramètres de confidentialité, mais aussi le révoquer à tout moment.
Vous y apprendrez également les traitements pour lesquels vous donnez spécifiquement votre consentement.</p>

<p>Certains traitements de vos données sont fondés sur notre intérêt légitime ou sur l’intérêt légitime de l’un de nos partenaires.
La base juridique applicable dans ce cas est soit l’intérêt légitime conformément à l’art. 6 al.
1f RGPD, soit l’intérêt privé prépondérant conformément à l’art. 13 LPD.
Vous avez à tout moment la possibilité de vous opposer au traitement sur la base d’un intérêt légitime ou d’un intérêt privé prépondérant.</p>


<p style="margin: 25px 0 10px 0; font-weight: 900" class="cmp-translations_purposes_header">Quelles sont les technologies que nous utilisons?</p>

<p>Nous utilisons les technologies suivantes:</p>

<p style="margin: 25px 0 10px 0; font-weight: 900" class="cmp-translations_purposes_header">a) Cookies</p>

<p>Les cookies sont utilisés sur nos sites web et applications mobiles par nous et par des tiers. Un cookie est un petit fichier texte qui est stocké sur votre appareil lorsque vous utilisez l’un de nos sites web.</p>

<p>Les cookies peuvent être divisés en cookies de session et en cookies permanents.</p>

<p>Les cookies de session peuvent être utilisés pour suivre les pages web que vous visitez et les options que vous utilisez. Un cookie de session n’est stocké que pour la durée de votre visite sur Internet, c’est-à-dire pendant une seule session Internet. Ainsi, lorsque vous fermez votre navigateur Internet, la session est terminée et le cookie est supprimé.</p>

<p>Les cookies permanents peuvent être utilisés, entre autres, pour nous souvenir de vous lors d’une visite ultérieure sur l’un de nos sites web et, par exemple, pour reconnaître vos préférences de lecture. Un cookie permanent est stocké pour une durée supérieure à une seule session.</p>

<p>Les cookies peuvent également être divisés en cookies fonctionnels et non fonctionnels.
Nous utilisons des cookies fonctionnels et non fonctionnels sur nos sites web.</p>

<p>Les cookies fonctionnels sont nécessaires pour assurer la fonctionnalité de nos sites web ou services. Les cookies non fonctionnels ne sont pas indispensables à la fonctionnalité des sites web. Ces types de cookies sont utilisés pour collecter et analyser des données sur l’utilisation des sites web ou des applications mobiles (préférences linguistiques, durée d’une session utilisateur, etc.) afin d’améliorer votre expérience de lecture et relative à la publicité.</p>


<p style="margin: 25px 0 10px 0; font-weight: 900" class="cmp-translations_purposes_header">b) Fichiers journaux</p>

<p>Lors de la visite de sites web ou applications mobiles, les serveurs web enregistrent des données d’utilisation non personnelles ou fichiers journaux. Les fichiers journaux fournissent des informations sur votre adresse IP, le système d’exploitation utilisé, les pages web que vous visitez, le type et la version du navigateur, la date, l’heure et le fichier demandé. Ces informations sont techniquement nécessaires pour fournir correctement le contenu des pages web que vous avez demandées et sont incontournables lors de l’utilisation d’Internet. Ces données sont stockées séparément de toutes les données personnelles que vous avez pu fournir et ne permettent donc pas de tirer des conclusions sur votre personne.</p>

<p>Ces données d’utilisation sont évaluées statistiquement par nos soins afin d’optimiser notre présence sur Internet et la technologie qui la sous-tend, de reconnaître les tendances ainsi que d’améliorer les offres et les produits ou de les adapter au mieux à vos besoins.</p>

<p style="margin: 25px 0 10px 0; font-weight: 900" class="cmp-translations_purposes_header">c) Eléments provenant d’autres sites web, par exemple de plug-ins</p>

<p>Des éléments provenant de fournisseurs tiers (par exemple, des réseaux sociaux tels que Facebook, Apple, Twitter et YouTube) peuvent être utilisés sur nos sites web et applications mobiles. Si vous cliquez sur un élément d’un prestataire tiers (p. ex. «J’aime» avec le plug-in Facebook), un lien vers le serveur du prestataire tiers peut être établi automatiquement. C’est pourquoi des données concernant votre visite sur notre site web ou une application mobile peuvent être transmises au prestataire tiers. Suivant les cas, ces données peuvent être rattachées à votre compte utilisateur chez le prestataire tiers (p. ex. compte Facebook ou Twitter). En outre, le prestataire tiers peut transmettre à Ringier des données personnelles relatives à votre compte utilisateur (nom, prénom, numéro de client et adresse e-mail), dans la mesure où vous avez accepté cette option auprès dudit prestataire tiers. Vous trouverez des informations sur la collecte et l’utilisation des données par des prestataires tiers dans les déclarations relatives à la protection des données du prestataire tiers en question.</p>

<p style="margin: 25px 0 10px 0; font-weight: 900" class="cmp-translations_purposes_header">d) Traqueur de localisation</p>
<p>Dans notre application mobile, nous pouvons vous montrer des publicités géolocalisées en utilisant les données de localisation de votre appareil. Vous pouvez activer ou désactiver cette fonction à tout moment dans l’application sous «Paramètres».</p>`
		},
		tab2: {
			menu: 'Traitement de vos données',
			back: 'Retour',
			save: 'Fermer et sauvegarder',
			description: `<p>En principe, vos données sont traitées soit sur la base d’un intérêt légitime de la part de Ringier, soit parce que vous nous avez donné l’autorisation de traiter vos données. Vous trouverez de plus amples informations à ce sujet ici: <a onclick="__tcfapi('showConsentDetailView', 2, function () {}, {tab: 0})">Informations générales</a></p>

<p>Si vous vous opposez au traitement des données fondé sur l’intérêt légitime ou si vous souhaitez retirer votre consentement, vous pouvez le faire dans nos <a href="https://www.blick.ch/services/datenschutzbestimmungen-id151553.html" target="_blank" rel="noopener">dispositions relatives à la protection des données</a> à la section 4.3.
</p>`
		}
	},
	publisherConsents: {
		title: 'Base juridique du traitement de vos données par Ringier'
	},
	vendorConsents: {
		title: 'Consentement pour les partenaires'
	},
	purposes: {
		active: 'On',
		inactive: 'Off',
		acceptButton: 'Consentement',
		legitimateInterest: 'Intérêt légitime',
		legIntActive: 'On',
		legIntInactive: 'Off',
		showVendors: 'Afficher les partenaires IAB',
		purpose1: {
			title: 'Stocker et/ou accéder à des informations sur un terminal',
			description: '<p>Les cookies, identifiants de votre terminal ou autres informations peuvent être stockés ou consultés sur votre terminal pour les finalités qui vous sont présentées.</p>'
		},
		purpose2: {
			title: 'Sélectionner des publicités standard',
			description: '<p>Les publicités peuvent vous être présentées en fonction du contenu éditorial que vous consultez, de l’application que vous utilisez, de votre localisation approximative, ou de votre type de terminal.</p>'
		},
		purpose3: {
			title: 'Créer un profil personnalisé de publicités',
			description: '<p>Un profil peut être créé sur vous et sur vos centres d’intérêt pour vous présenter des publicités personnalisées susceptibles de vous intéresser.</p>'
		},
		purpose4: {
			title: 'Sélectionner des publicités personnalisées',
			description: '<p>Des publicités personnalisées peuvent vous être présentées sur la base d’un profil créé sur vous.</p>'
		},
		purpose5: {
			title: 'Créer un profil pour afficher un contenu personnalisé',
			description: '<p>Un profil peut être créé sur vous et sur vos centres d’intérêt afin de vous présenter du contenu personnalisé susceptible de vous intéresser.</p>'
		},
		purpose6: {
			title: 'Sélectionner du contenu personnalisé',
			description: '<p>Du contenu personnalisé peut vous être présenté sur la base de votre profil utilisateur.</p>'
		},
		purpose7: {
			title: 'Mesurer la performance des publicités',
			description: '<p>La performance et l’efficacité des publicités que vous voyez ou avec lesquelles vous interagissez peuvent être mesurées.</p>'
		},
		purpose8: {
			title: 'Mesurer la performance du contenu',
			description: '<p>La performance et l’efficacité du contenu que vous voyez ou avec lequel vous interagissez peuvent être mesurées.</p>'
		},
		purpose9: {
			title: 'Exploiter des études de marché afin de générer des données d’audience',
			description: '<p>Les études de marché peuvent servir à en apprendre davantage sur les audiences qui visitent des sites/utilisent des applications et voient des publicités.</p>'
		},
		purpose10: {
			title: 'Développer et améliorer les produits',
			description: '<p>Vos données peuvent être utilisées pour améliorer les systèmes et logiciels existants et pour développer de nouveaux produits.</p>'
		}
	},
	specialPurposes: {
		title: 'Des fins spéciales', // ???
		showVendors: 'Afficher les partenaires IAB',
		purpose1: {
			title: 'Assurer la sécurité, prévenir la fraude et déboguer',
			description: '<p>Vos données peuvent être utilisées pour surveiller et prévenir les activités frauduleuses, et s’assurer que les systèmes et processus fonctionnent correctement et en toute sécurité.</p>'
		},
		purpose2: {
			title: 'Diffuser techniquement les publicités ou le contenu',
			description: '<p>Votre terminal peut recevoir et envoyer des informations qui vous permettent de voir des publicités et du contenu et d’interagir avec eux.</p>'
		}
	},
	features: {
		title: 'Fonctions',
		...
		showVendors: 'Afficher les partenaires IAB',
		feature1: {
			title: 'Mettre en correspondance et combiner des sources de données hors ligne',
			description: '<p>Les données issues de sources de données hors ligne peuvent être combinées à votre activité en ligne à l’appui d’une ou de plusieurs finalités.</p>'
		},
		feature2: {
			title: 'Relier différents terminaux',
			description: '<p>Différents terminaux peuvent être identifiés comme vous appartenant ou appartenant à votre foyer à l’appui d’une ou de plusieurs finalités.</p>'
		},
		feature3: {
			title: 'Recevoir et utiliser des caractéristiques d’identification d’appareil envoyées automatiquement',
			description: '<p>Votre appareil peut être distingué d’autres appareils en fonction des informations qu’il envoie automatiquement, telles que l’adresse IP ou le type de navigateur.</p>'
		}
	},
	specialFeatures: {
		...
		showVendors: 'Afficher les partenaires IAB',
		feature1: {
			title: 'Utiliser des données de géolocalisation précises',
			description: '<p>Vos données de géolocalisation précises peuvent être utilisées à l’appui d’une ou de plusieurs finalités. Cela signifie que votre localisation peut être précise à plusieurs mètres près.</p>'
		},
		feature2: {
			title: 'Analyser activement les caractéristiques du terminal pour l’identification',
			description: '<p>Votre terminal peut être identifié sur la base d’une analyse de la combinaison unique de caractéristiques de votre terminal.</p>'
		}
	},
	consentInfo: {
		consents: {
			title: 'Consentement',
			description: '<p>Dans la liste ci-dessous, vous trouverez un bouton pour le consentement. «On» signifie que tous les partenaires peuvent traiter vos données aux fins indiquées. Vous pouvez révoquer votre consentement à tout moment en plaçant le curseur sur «Off».</p>'
		},
		legitimateInterests: {
			title: 'Intérêt légitime',
			description: '<p>Il y a un bouton «Intérêt légitime» dans la liste ci-dessous. Certains traitements de données ne nécessitent pas votre consentement. Elles sont traitées sur la base de l’intérêt légitime ou privé prépondérant d’un partenaire de Ringier. Mettez ce commutateur sur «Off» si vous ne souhaitez pas que vos données soient traitées par Ringier aux fins mentionnées ci-dessous sur la base de l’intérêt légitime ou privé prépondérant du partenaire.</p>'

		}
	},
	iabVendors: {
		title: 'Partenaires certifiés IAB',
		company: 'Partenaires IAB',
		offOn: 'Votre Consentement ',
		description: 'Vous trouverez ci-dessous une liste des partenaires certifiés IAB et de leurs traitements que vous pouvez accepter, comme décrit dans la fenêtre précédente. Ce consentement nous permet de mieux adapter le contenu et les publicités de nos partenaires certifiés IAB à vos intérêts. Si vous ne souhaitez pas accepter un partenaire certifié IAB spécifique, cliquez sur «Modifier les paramètres des partenaires suivants» ci-dessous et décochez l’option sélectionnée.',
		editingDescription: 'Vous trouverez ci-dessous une liste des partenaires certifiés IAB et de leurs traitements que vous pouvez accepter, comme décrit dans la fenêtre précédente. Ce consentement nous permet de mieux adapter le contenu et les publicités de nos partenaires certifiés IAB à vos intérêts. Si vous ne souhaitez pas accepter un partenaire certifié IAB spécifique, cliquez sur «Modifier les paramètres des partenaires suivants» ci-dessous et décochez l’option sélectionnée.',
		moreChoices: 'Modifier les paramètres des partenaires suivants',
		legitimateInterest: 'Intérêt légitime',
		acceptButton: 'Consentement',
		active: 'On',
		inactive: 'Off'
	...
	definitions: {
		specialPurposes: 'Finalités particulières',
		specialFeatures: 'Besonderheiten',
		purposes: 'Finalités du traitement',
		legitimateInterestPurposes: 'Finalité du traitement sur la base de l’intérêt légitime',
		features: 'Fonctions'
	},
	footer: {
		message: '',
...
const embedTransaltion = {
	en: {
		intro: {
			title: 'Dear User,',
			description: `<p>Before you click “Go to website” or close this window please read this notice in whole – it concerns your personal data.<br><span style="font-weight: bold; display: inline">By clicking “Go to website” or closing this window by clicking the X sign you grant consent for processing of your personal data</span> relating to your activity in the Internet by the <a onclick="__tcfapi('showVendors', 2, function () {})">Trusted Partners</a> for marketing purposes (including personalization od the ads and measurements). <a href="https://polityka-prywatnosci.onet.pl/index.html" target="_blank" rel="noopener">Here</a> you find detailed description of the purposes and scope of the processed data. The consent is voluntary. You may refuse it or limit its scope clicking on “Advanced settings”.</p>
<p>Entities from the <a href="https://polityka-prywatnosci.onet.pl/grupa-rasp.html" target="_blank" rel="noopener">RAS Polska Group</a> as provides of the Internet services you use process your personal data specified above together with data from your accounts in these services  on the basis of legitimate, common interest of these entities. Such processing does not require your consent, but you may object to it at any time.</p>
<p>Your rights:<br>You may withdraw the granted consent at any time.<br>You may also demand access to your personal data, rectification of data, erasure or restriction of processing, right to transfer data (data portability), right to object to data processing and the right to lodge a complaint to the President of the Personal Data Protection Office in Poland.</p>
<p>Detailed information is available in “Advanced settings”.</p>
<p>Using the service without adjustment of the browser is also considered as consent for to the placement of web flags/markers (cookies, etc.) on your device and reading them by Entities from the <a href="https://polityka-prywatnosci.onet.pl/grupa-rasp.html" target="_blank" rel="noopener">RAS Polska Group</a> and <a onclick="__tcfapi('showVendors', 2, function () {})">Trusted Partners</a>. You may refuse the consent or limit its scope by changing the browser settings (you will find detailed information <a href="https://polityka-prywatnosci.onet.pl/index.html" target="_blank" rel="noopener">here</a>).</p>`,
...
<!--<br>-->
<p>The aforementioned consent concerns the processing of your personal data for marketing purposes of <a onclick="__tcfapi('showVendors', 2, function () {})">Trusted Partners</a>. Trusted Partners are e-commerce companies and advertisers as well as media houses acting on their behalf and similar organizations, with whom the RAS Polska Group cooperates or which are recommended by international industry organizations, such as IAB (Interactive Advertising Bureau). Some of the Trusted Partners may process your data in a narrower scope, some of them may process your data on a basis other than your consent (for example, based on legitimate controller’s interest). A full list of Trusted Partners together with the scope of data processed by them based on your consent or any other legal ground can be found at this <a onclick="__tcfapi('showVendors', 2, function () {})">link</a>.</p>
<p>Entities from the RAS Polska Group, as part of Internet services provided by them, process your data specified above as well as aggregated information about age, sex and location (size of the city you come from, etc.) originating from your accounts in services rendered by entities from the RAS Polska Group for marketing purposes on the basis of a legitimate, common interest of entities from the RAS Polska Group. These data are also necessary for the performance of a contract that we executed with you, concerning your use of our services and websites, in light of the nature of those services. The provisions of the contract are determined by terms of use of the Onet portal - <a href="https://polityka-prywatnosci.onet.pl/regulamin.html" target="_blank" rel="noopener">https://polityka-prywatnosci.onet.pl/regulamin.html</a> - or by terms of use of other services rendered by the RAS Polska Group entities.</p>
<p>A legitimate interest of the controller constitutes one of the grounds for processing of personal data (together with, for example, consent or the need to perform a contract) and comprises circumstances where data controller, due to legitimate purposes, may process personal data while not violating rights, freedoms and interests of a data subject. Processing of personal data for direct marketing purposes constitutes an example of such case, as described in applicable regulations.</p>
...
<ul style="list-style-position: inside; list-style-type: disc;">
	...
	<li style="margin-bottom: 20px">2. Ensuring security of a service (for example, checking if your account is not accessed by an unauthorized person), performing statistical measurements, improving our services and adapting them to the needs and convenience of users (for example, customizing content in services) as well as for the purpose of <span style="font-weight: bold; display: inline">direct</span> marketing (also at advertisers’ requests) or promotion of our own services (for example, if you’re interested in history and watch content concerning history on Onet website or other websites, we may show an ad regarding an article on Onet Podróże website about historical trails). Such processing constitutes a performance of our legitimate interests, in such case we always carry out balance tests between our legitimate interest and rights of data subjects.</li>
	<li>3. Upon your consent, marketing services will be provided to you by our <a onclick="__tcfapi('showVendors', 2, function () {})">Trusted Partners</a> and by us for the benefit of third parties. In order to show you advertisements you’re interested in (for example, a product you might need), advertisers and their representatives would like to process your data associated with websites you visited. Such consent is voluntary and you are not obliged to provide it, it will not prevent you from accessing our services. You are also able to restrict the scope of processing or change consent at any time.</li>
</ul>
...
<p style="margin: 25px 0 10px 0">In the tab below, you will be able to find necessary information about purposes and scope of as well as grounds for processing of your personal data, controllers of those data and you will be able to manage such processing.</p>
<p style="margin: 25px 0 10px 0">You can specify to which of <a onclick="__tcfapi('showVendors', 2, function () {})">Trusted Partners</a> you wish to grant consent for processing of your personal data and to specify the purposes of processing to which your consent pertains – this can be done by means of a slider named “consent”. Leaving the slider unchecked (it will be grey) will mean no consent, and clicking the slider will mean that the consent has been granted (the slider will change its color and will no longer be grey) – the scope of consent is specified next to a given slider. After making the choice, please remember to confirm by clicking the <span style="font-weight: bold; display: inline">„Save and close”</span> button.</p>\
...
<ul style="list-style-position: inside; list-style-type: disc;">
	...
	<li style="margin-bottom: 10px">
		...
		<br>
		N.B. Non-precise means only an approximate location involving at leasta radius of 500 meters is permitted.
	</li>
	<li style="margin-bottom: 10px">
	...
	<li style="margin-bottom: 10px">
		...
		<br>
		- Select personalisedads based on a user profile or other historical user data, including a user’s prior activity, interests, visits to sites or apps, location, or demographic information.
	</li>
	<li style="margin-bottom: 10px">
...
<ul style="list-style-position: inside; list-style-type: disc;">
	<li style="margin-bottom: 10px">
		...
		Note: Precise geolocation means that there are no restrictions on the precision of a user’s location; this can be accurate to within several meters.
	</li>
	<li style="margin-bottom: 10px">
...
<p style="margin: 25px 0 10px 0">If you have any doubts, please contact us at <a href="mailto:iod@ringieraxelspringer.pl">iod@ringieraxelspringer.pl</a>. Helpful information can also be found in our <a href="https://polityka-prywatnosci.onet.pl/index.html" target="_blank" rel="noopener">Privacy Policy</a>.</p>`
		...
		purposes: {
			...
			title: 'Purposes',
			purpose1: {
				title: 'Storing information on a device or access to information',
				description: '<p>Cookies, device IDs or other information may be stored on the user’s device or provided on the device for the purposes notified to the user.</p>'
			},
			purpose2: {
				title: 'Selection of basic advertisements',
				description: '<p>Advertisements may be displayed based on viewed content, app used, approximate location or device type.</p>'
			},
			purpose3: {
				title: 'Creating a profile of personalized advertisements',
				description: '<p>A profile may be created for the user and user’s interests, which will allow to display personalized advertisements relevant to the user.</p>'
			},
			purpose4: {
		...
		iabVendors: {
			...
			company: 'Partner',
			offOn: 'Accept',
			description: 'Below is a list of entities to which you can give consent, described in the previous window. Thanks to this consent, it will be possible to better match the content and advertisements presented by our Trusted Partners to your interests. If you do not agree to a Trusted Partner, click "Change settings of Trusted Partners" below and uncheck the selected option.',
			editingDescription: 'Below is a list of entities to which you can give consent, described in the previous window. Thanks to this consent, it will be possible to better match the content and advertisements presented by our Trusted Partners to your interests. If you do not agree to a Trusted Partner, click "Change settings of Trusted Partners" below and uncheck the selected option.',
		...
		definitions: {
			specialPurposes: 'Particular purposes',
			specialFeatures: 'Special functionalities',
			purposes: 'Purposes',
			legitimateInterestPurposes: 'Controller’s Legitimate Interest',
	...
	pl: JSON.parse(replaceMacros(pl, 'pl')),
	pl_gratka: JSON.parse(replaceMacros(pl, 'pl_gratka')),
	//blick.ch
